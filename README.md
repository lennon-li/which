# Which — Planned Research and Software Roadmap

> **Planned work, not a description of completed software.** This repository's
> proposed direction is the research and development project below. The proposal
> is a faculty-review draft; funding has not been confirmed, and proposed
> components, evaluations, partnerships, and pilots should not be assumed to
> exist or be approved. Existing related work is identified explicitly in the
> proposal.
